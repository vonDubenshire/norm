...
class JokeApp {
    constructor() {
        ...
        this.jokeCounterElement = document.getElementById('joke-counter');
    ...
    displayCurrentJoke() {
        ...
        // Also fade out the counter for a smoother transition
        this.jokeCounterElement.style.transition = 'opacity 0.2s ease-out';
        this.jokeCounterElement.style.opacity = '0.5';
        ...
        setTimeout(() => {
            ...
            // Update counter
            this.jokeCounterElement.textContent = `Joke ${this.currentJokeIndex + 1} of ${this.totalJokes}`;
            ...
            this.jokeCounterElement.style.transition = 'opacity 0.3s ease-in';
            this.jokeCounterElement.style.opacity = '1';
